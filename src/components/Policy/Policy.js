        ...
        <li className='policy__item policy__item_title'>
          ...
          <ol className='policy__list policy__list_down'>
            ...
            <li className='policy__item'>
              ...
              доступность в сети интернет по сетевому адресу https://estraid.com/;
            </li>
            <li className='policy__item'>
            ...
            <li className='policy__item'>
              Пользователь – любой посетитель веб-сайта https://estraid.com/;
            </li>
            <li className='policy__item'>
         ...
         <li className='policy__item policy__item_title'>
          ...
          <ol className='policy__list policy__list_down'>
            <li className='policy__item'>
              ...
              https://estraid.com/. Заполняя соответствующие формы и/или отправляя
        ...
        <li className='policy__item policy__item_title'>
          ...
          <ol className='policy__list policy__list_down'>
            ...
            <li className='policy__item'>
              ...
              сети Интернет по адресу https://estraid.com/policy
            </li>
          </ol>
        </li>
      </ol>
